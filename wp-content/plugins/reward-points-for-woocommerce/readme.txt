...
[PREMIUM VERSION LIVE DEMO](http://reward.phoeniixxdemo.com/wp-admin) | [PREMIUM VERSION LINK](https://www.phoeniixx.com/product/reward-points-for-woocommerce/) | [DOCUMENTATION LINK](https://www.phoeniixx.com/wp-content/uploads/2017/06/reward-points.pdf)

* <strong>New</strong> User can choose the points to apply at the cart and checkout page. 
* <strong>New</strong> User can apply the points at the checkout page also.
* <strong>New</strong> Option to set points based on the price range.
* <strong>New</strong> Option to set the Percentage(%) For Product Price
* <strong>New</strong> Option to set the limit for Threshold Redeem points.
* <strong>New</strong> Option to set the Referral Points.
* <strong>New</strong> Option to set the Birthday Points. 
