    ...
    <div class="product-view">
        <figure class="double-img">
            <a href="product-details.html"><img class="btm-img" width="215"
                                                height="240" alt=""
                                                data-pagespeed-url-hash="4017406826"
                                                src=""
                >
...
<div class="product-info">
    <h3 class="product-name"><a href="product-details.html">Mascara Mistine Tip
            2 Tail Thái Lan</a></h3>
</div>
<div class="product-price"><span class="real-price text-info"><span
            class="real-price text-info"><strong>1320.000₫</strong></span></span>
    <span class="old-price">100.000₫</span></div>