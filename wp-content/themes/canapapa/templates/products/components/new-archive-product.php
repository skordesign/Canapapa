        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 product-item-container effect-wrap effect-animate"
            ...
            <div class="product-item-container effect-wrap effect-animate slick-slide slick-cloned"
                ...
                <div class="product-main">
                    <div class="product-view">
                        ...
                        <figure class="double-img">
                            <a href=""><img class="btm-img" width="215" height="240"
                                            alt="<?php the_title(); ?>"
                        ...
                        <!--                    <span class="label offer-label-right">36% giảm</span>-->
                    </div>
                    <div class="product-btns  effect-content-inner">
                        <p class="effect-icon">
                            <a href="<?php echo $product->get_id(); ?>" class="hint-top"
                ...
                <span class="real-price text-info">
                    <span class="real-price text-info"><strong><?php echo $product->regular_price; ?></strong></span>
                </span>
                    <span lass="old-price"><?php echo $product->price; ?></span>
                </div>
            </div>
        </div>
