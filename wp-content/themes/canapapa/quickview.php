    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body product-details">
                <div class="row">
                    <div class="col-sm-7"><img class="img-responsive" width="700" height="700" alt=""
                                               data-pagespeed-url-hash="4273646131" src="images/pro1.jpg"
                                               onerror="this.onerror=null;pagespeed.lazyLoadImages.loadIfVisibleAndMaybeBeacon(this);"
                                               data-pagespeed-lazy-replaced-functions="1"></div>
